...
"border-color: rgb(0, 0, 0);")
        ...
        self.playback_slider = QtWidgets.QSlider(self.animation_player)
        self.playback_slider.setEnabled(False)
        self.playback_slider.setMinimumSize(QtCore.QSize(22, 0))
        self.playback_slider.setMaximumSize(QtCore.QSize(22, 16777215))
        self.playback_slider.setMaximum(2)
        self.playback_slider.setPageStep(1)
        self.playback_slider.setSliderPosition(1)
        self.playback_slider.setOrientation(QtCore.Qt.Vertical)
        self.playback_slider.setInvertedAppearance(False)
        self.playback_slider.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.playback_slider.setTickInterval(1)
        self.playback_slider.setObjectName("playback_slider")
        self.gridLayout.addWidget(self.playback_slider, 0, 3, 1, 1)
